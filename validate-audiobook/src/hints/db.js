export const db = {
  ...
  // TODO(daneroo) This is a series - needs to be split into directories
  '/Volumes/Space/archive/media/audiobooks/Alistair Reynolds - Revelation Space': {
    // Non-unique Title:  ["Revelation Space 01 Revelation Space","Revelation Space 02 Chasm City","Revelation Space 03 Redemption Ark","Revelation Space 04 Absolution Gap","Revelation Space 05 The Prefect"]
    title: ''
  },
  ...
  '/Volumes/Space/archive/media/audiobooks/Bernard Cornwell, The Arthur series Complete and Unabridged/1 The Winter King': {
    // Non-unique Author: [null,"Bernard Cornwell"]
    author: 'Bernard Cornwell',
    // Non-unique Title:  [null,"Enemy of God"]
  ...
  '/Volumes/Space/archive/media/audiobooks/BillBryson-5Audiobooks': {
    // Non-unique Title:  ["A Short History of Nearly Everything","Shakespeare - The World as Stage -- Disc 1 of 5","Shakespeare - The World as Stage -- Disc 2 of 5","Shakespeare - The World as Stage -- Disc 3 of 5","Shakespeare - The World as Stage -- Disc 4 of 5","Shakespeare - The World as Stage -- Disc 5 of 5"]
    title: ''
  },
  ...
  '/Volumes/Space/archive/media/audiobooks/Brandon Sanderson - Cosmere/Sanderson, Brandon - Cosmere 1 - Mistborn 1 - The Final Empire': {
    // Non-unique Title:  ["The Final Empire","Mistborn"]
    title: 'The Final Empire'
  },

  // TODO(daneroo) This may be part of Arcanum Unbounded - Chapter 64-66
  ...
  // TODO(daneroo) This may be part of Arcanum Unbounded - Chapter 25-26
  ...
  // TODO(daneroo) This may be part of Arcanum Unbounded - Chapter 68-88
  ...
  '/Volumes/Space/archive/media/audiobooks/Brandon Sanderson - Cosmere/Sanderson, Brandon - Cosmere 2 - Mistborn 2 - The Well of Ascension': {
    // Non-unique Title:  ["The Well of Ascension",""]
    title: 'The Well of Ascension'
  },
  // TODO(daneroo) This may be part of Arcanum Unbounded - Chapter 54,55-57
  ...
  // TODO(daneroo) This may be part of Arcanum Unbounded - Chapter 23-24
  ...
  // TODO(daneroo) This may be part of Arcanum Unbounded - Chapter 27-53
  ...
  '/Volumes/Space/archive/media/audiobooks/Brandon Sanderson - Cosmere/Sanderson, Brandon - Cosmere 6 - Elantris 1 - Elantris': {
    // Non-unique Author: [null,"Brandon Sanderson"]
    author: 'Brandon Sanderson',
    // Non-unique Title:  [null,"Elantris"]
    title: 'Elantris'
  },
  // TODO(daneroo) This may be part of Arcanum Unbounded - Chapter 3-19
  ...
  // TODO(daneroo) This may be part of Arcanum Unbounded - Chapter 20-21
  ...
  '/Volumes/Space/archive/media/audiobooks/Frank Herbert - Dune Collection/01 - Dune Saga': {
    // Non-unique Author: ["Frank Herbert (audio)","Brian Herbert & Keven J. Anderson (audio)"]
    author: '',
    // Non-unique Title:  ["Dune","Dune Messiah","Children of Dune","God Emperor of Dune","Heretics of Dune","Chapterhouse: Dune","Hunters of Dune","Sandworms of Dune"]
    title: ''
  },
  ...
  '/Volumes/Space/archive/media/audiobooks/LisaRandall-DarkMatterAndTheDinosaurs': {
    // author is unique but combined narrator: i.e. TPE1=Lisa Randall/Carrington MacDuffie
    author: 'Lisa Randall',
